                  ...
                  Container(
                      ...
                      child: Container(
                          ...
                          child: Column(children: [
                                        ...
                                        Wrap(
                                            ...
                                            children:
                                                BlocProvider.of<CategoryBloc>(
                                                    ...
                                                    .listCate
                                                    .map((valueOfCategory) {
                                              return selectedArea(context, true,
                                                  valueOfCategory);
                                            }).toList()),
                            ...
                            selectedArea(
                                context, false, Category.POPULAR_CATEGORY[0]),
                            selectedArea(
                                context, false, Category.POPULAR_CATEGORY[1]),
                            selectedArea(
                                context, false, Category.POPULAR_CATEGORY[2]),
                            selectedArea(
                                context, false, Category.POPULAR_CATEGORY[3]),
                          ]))),
                ],
              ),
            ),
        ...
        if (hasIcon == false) {
          ...
          if (hasValue) {
            showDialog(
                ...
                builder: ((context) {
                  return AlertDialog(
                    title: Text(Category.WARNING_MESSAGE),
                  );
                }));
          } else {
